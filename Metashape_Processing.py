...
for chunk in Metashape.app.document.chunks:
    ...
    firstit_points = len([p for p in chunk.tie_points.points if p.valid])
    ...
    secondit_points = len([p for p in chunk.tie_points.points if p.valid])
    ...
    thirdit_points = len([p for p in chunk.tie_points.points if p.valid])
